...
var completionTestCases = []completionTestCase{
	// ── dot field completions ────────────────────────────────────────────────
	{
		...
		subStr:   ".",
		withType: true,
		contains: []string{"ID", "CustomerName", "Email", "Address", "Items", "TotalAmount", "Paid"},
	},
	{
	...
	},
	{
		...
		subStr:      "l",
		withType:    true,
		contains:    []string{".DisplayName", ".Summary", ".ItemCount", ".IsLargeOrder", ".Format", ".ID", ".CustomerName", ".Paid"},
		notContains: []string{".wrongSecond", ".badReturn"},
	},
	{
	...
	// ── user method pipe filtering ───────────────────────────────────────────
	{
		...
		isInvoked:   true,
		withType:    true,
		notContains: []string{".Format", ".DisplayName", ".ItemCount", ".IsLargeOrder", ".wrongSecond"},
	},
	{
	...
	// ── builtin chained with model ───────────────────────────────────────────
	{
		...
		notContains: []string{"html", "not", ".Oper", ".DisplayName", ".ItemCount", ".IsLargeOrder"},
	},
	{
	...
	},
	{
		...
		isInvoked:   true,
		withType:    true,
		notContains: []string{".IsExpensive", ".Describe", ".Label", ".DisplayName", ".IsLargeOrder"},
	},
	{
	...
	// ── builtin suggestions ──────────────────────────────────────────────────
	{
		...
		src:      `{{len .}}`,
		subStr:   "l",
		contains: []string{"len", "eq", "ne", "and", "or", "not", "print", "printf", "println", "index"},
	},
	{
